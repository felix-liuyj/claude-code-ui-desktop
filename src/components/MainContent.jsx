    ...
    if (isLoading) {
        return (
            <div className="h-full flex flex-col">
                ...
                { isMobile && (
                    <div
                        className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-3 sm:p-4 flex-shrink-0">
                        <button
                            onClick={ onMenuClick }
        ...
        <div className="h-full flex flex-col">
            ...
            <div
                            ...
                            { activeTab === 'chat' && selectedSession ? (
                                <div>
                                    ...
                                    <div className="text-xs text-gray-500 dark:text-gray-400 truncate">
                                        ...
                                        className="hidden sm:inline">• { selectedSession.id }</span>
                                    </div>
                                </div>
                            ) : activeTab === 'chat' && !selectedSession ? (
                                <div>
                                ...
                                <div>
                                    <h2 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">
                                        { activeTab === 'files' ? '项目文件' : activeTab === 'git' ? '源代码控制' : '项目' }
                                    </h2>
                                    <div className="text-xs text-gray-500 dark:text-gray-400 truncate">
                                        { selectedProject.displayName }
                                    </div>
                ...
                <span className="flex items-center gap-1 sm:gap-1.5">
                  ...
                  <span className="hidden sm:inline">源代码控制</span>
                </span>
                            </button>
                            {/* <button
