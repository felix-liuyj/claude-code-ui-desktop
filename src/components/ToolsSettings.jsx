                    ...
                    <span className="font-mono text-sm text-red-800 dark:text-red-200">
                      { tool }
                                ...
                                <div
                                    ...
                                    <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                                        <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Bash(git
                                            log:*)"</code> - Allow all git log commands
                                        </li>
                                        <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Bash(git
                                            diff:*)"</code> - Allow all git diff commands
                                        </li>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        <p className="text-sm text-muted-foreground">
                                            Model Context Protocol servers provide additional tools and data sources to
                                            Claude
                                        </p>
                                    </div>
                                            ...
                                            <form onSubmit={ handleMcpSubmit } className="p-4 space-y-4">
                                                ...
                                                <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                                                    <div className="flex items-center justify-between mb-3">
                                                        <h4 className="font-medium text-foreground">Configuration
                                                            Test</h4>
                                                        <Button
                                                            type="button"
                                                    ...
                                                    <p className="text-sm text-muted-foreground mb-3">
                                                        You can test your configuration to verify it's working
                                                        correctly.
                                                    </p>
